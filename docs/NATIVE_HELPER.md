...
Java в проекте сейчас не используется. Go выбран точечно: он собирает один
маленький статический helper для Windows, macOS и Linux без JVM, установщика JRE
и дополнительных runtime-зависимостей для пользователя.
